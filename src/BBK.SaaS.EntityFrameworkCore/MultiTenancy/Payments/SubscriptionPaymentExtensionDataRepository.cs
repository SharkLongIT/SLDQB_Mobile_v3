...
{
    public class SubscriptionPaymentExtensionDataRepository : SaaSRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<SaaSDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
