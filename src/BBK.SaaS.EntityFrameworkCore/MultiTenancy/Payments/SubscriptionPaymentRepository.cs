...
using BBK.SaaS.EntityFrameworkCore.Repositories;

namespace BBK.SaaS.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : SaaSRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<SaaSDbContext> dbContextProvider)
