...
using BBK.SaaS.Core.Base;
using BBK.SaaS.Core.Extensions;
using BBK.SaaS.Dto;
using BBK.SaaS.Types;

namespace BBK.SaaS.Queries
{
    public class OrganizationUnitQuery : SaaSQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
