...
{
    public class SaaSAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public SaaSAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
