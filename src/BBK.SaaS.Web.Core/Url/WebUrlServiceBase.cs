...
namespace BBK.SaaS.Web.Url
{
    public abstract class WebUrlServiceBase
    {
        ...
        public string WebSiteRootAddressFormat => _appConfiguration[WebSiteRootAddressFormatKey] ?? _appConfiguration["App:WebSiteRootAddress"];

        public string ServerRootAddressFormat => _appConfiguration[ServerRootAddressFormatKey] ?? _appConfiguration["App:WebSiteRootAddress"];
