...
using BBK.SaaS.DynamicEntityProperties;
using BBK.SaaS.Web.Areas.App.Models.DynamicEntityProperty;
...
namespace BBK.SaaS.Web.Areas.App.Controllers
{
    ...
    public class DynamicEntityPropertyController : SaaSControllerBase
    {
