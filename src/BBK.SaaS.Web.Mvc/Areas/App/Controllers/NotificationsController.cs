...
using BBK.SaaS.Organizations;
using BBK.SaaS.Web.Areas.App.Models.Notifications;
using BBK.SaaS.Web.Areas.App.Models.OrganizationUnits;
...
namespace BBK.SaaS.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class NotificationsController : SaaSControllerBase
    {
