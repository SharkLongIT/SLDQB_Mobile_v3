    ...
    public class ProfileSideBarViewComponent : SaaSViewComponent
    {
        ...
        public MenuDefinition GetDefaultNLDMenu()
        {
            ...
            menu
                ...
                .AddItem(new MenuItemDefinition(
                        "Home.ContentManagement",
                        new FixedLocalizableString("Quản lý hồ sơ ứng tuyển")
                        ).AddItem(
                        ...
                        "Home.ContentManagement",
                        new FixedLocalizableString("Danh sách việc làm đã ứng tuyển")
                        ).AddItem(
                        new MenuItemDefinition(
                        "Home.ContentManagement",
                        ...
                        new MenuItemDefinition(
                        "Home.ContentManagement",
                        new FixedLocalizableString("Việc làm đã lưu"),
                        url: "#")
                    ).AddItem(
                        new MenuItemDefinition(
                        "Home.ContentManagement",
