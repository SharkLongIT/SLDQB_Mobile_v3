...
namespace BBK.SaaS.Web.Areas.Profile.Views.Shared.Components.ProfileUserMenu
{
    public class ProfileUserMenuViewComponent : SaaSViewComponent
    {
        private readonly IMultiTenancyConfig _multiTenancyConfig;
        private readonly IAbpSession _abpSession;
        private readonly IPerRequestSessionCache _sessionCache;

        public ProfileUserMenuViewComponent(
