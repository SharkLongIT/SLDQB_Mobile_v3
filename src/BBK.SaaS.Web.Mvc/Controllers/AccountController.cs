...
namespace BBK.SaaS.Web.Controllers
{
    public class AccountController : SaaSControllerBase
	{
		...
		public async Task<ActionResult> LoginTenant(string userNameOrEmailAddress = "", string returnUrl = "",
				string successMessage = "", string ss = "")
		{
			returnUrl = NormalizeReturnUrl(returnUrl);
			
			//// force to tenant default
		...
		public async Task<ActionResult> LoginHost(string userNameOrEmailAddress = "", string returnUrl = "",
				string successMessage = "", string ss = "")
		{
			returnUrl = NormalizeReturnUrl(returnUrl);

			//// force to tenant null
			//if (AbpSession.TenantId.HasValue)
			//{
			//	return Redirect("/Account/Login");
			//}
