(function ($) {
  ...
  $(document).ready(function () {
    $(".customizer-color li").on("click", function () {
      ...
      $("#color").attr("href", "/themes/mofi/assets/css/" + color + ".css");
    ...
    $(".sidebar-type li").on("click", function () {
      ...
      switch (type) {
        ...
        case "normal-sidebar": {
          ...
          $(".logo-wrapper")
            .find("img")
            .attr("src", "/themes/mofi/assets/images/logo/logo.png");
