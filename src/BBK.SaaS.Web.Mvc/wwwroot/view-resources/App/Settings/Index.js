(function () {
    ...
    function IsUserLockOutSettingsFormValid(){
        ...
        //kien them add danh muc địa chỉ , danh mục chung
        $("#btnGeoUnit").click(function () {
            $.ajax({
                url: '/Profile/Recruiters/AddGeoUnit',
                cache: false,
        ...
        $("#btnCatUnit").click(function () {
            $.ajax({
                url: '/Profile/Recruiters/AddCatUnit',
                cache: false,
                success: function (results) {
                    abp.notify.info(abp.localization.localize("Cập nhật danh mục thành công"));
                },
                error: function (xhr, ajaxOptions, thrownError) {
                    alert("error");
                }
