(function () {
  $(function () {
    ...
    var categoryTree = {
      ...
      contextMenu: function (node) {
        var items = {
          ...
          sortUnit: {
            ...
            _disabled: !_permissions.manageOrganizationTree,
            action: function (data) {
              var lookupModal = app.modals.SortingModal.create({
							  title: app.localize('DragAndDropToSortItem'),
							  serviceMethod: _categoryService.getSortableCategoryUnits,
							  //filterText: '',
							  //excludeCurrentUser: true,
							  onSelectionDone: function (parentId, sortedItems) {
								  console.log(sortedItems);
								  //console.log($(this)[0].dataset.id);

                  _categoryService.saveSortedCategoryUnits({ parentId: parentId, sortedIds: sortedItems }).done(function () {
                    categoryTree.reload(); 
      ...
      getTreeDataFromServer: function (callback) {
        _categoryService.getCmsCats({}).done(function (result) {
          ...
          categoryTree.$treeData = result.items;
          ...
          categoryTree.$tree
            ...
            .jstree({
              ...
              sort: function (node1, node2) {
                if (this.get_node(node2).original.orderIndex < this.get_node(node1).original.orderIndex) {
                  return 1;
                }
    ...
    $('#ReOrderRootUnitButton').click(function (e) {
			e.preventDefault();
          ...
          //console.log('On Selection Done!');
			...
			lookupModal.open({
				extraFilters: null,
				//title: app.localize('SelectAUser'),
      }, function () { console.log('CallBack Done!'); });
		});
