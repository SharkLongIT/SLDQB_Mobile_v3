    ...
    var dataTable = _$AppRequestTable.DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                targets: 3,
                render: function (data, type, row, meta) {
                    return row.jobApplication.candidate.account.surname + " " + row.jobApplication.candidate.account.name
                }
            },
            {
                orderable: false,
                    ...
                    items: [{
                        ...
                        action: function (data) {
                            ...
                            window.location.href =
                                "/Profile/JobApplication/Detail?id=" + data.record.jobApplicationId;
                        }
                    }
                        , {
                        text: app.localize('Đặt lịch'),
                        action: function (data) {
                            var dataFilter = { jobId: data.record.jobApplicationId };
