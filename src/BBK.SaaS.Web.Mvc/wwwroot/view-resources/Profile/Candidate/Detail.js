(function () {
    $(function () {
        ...
        var changeProfileAvatar  = new app.ModalManager({
            viewUrl: abp.appPath + 'Profile/Candidate/ChangePictureModal',
            scriptUrl: abp.appPath + 'view-resources/App/Profile/_ChangePictureModal.js',
            modalClass: 'ChangeProfilePictureModal',
        });

        _$candidateInfoForm.find('button.cancel').click(function () {
            window.location.href = abp.appPath + "Profile/UsersType/IndexCandidates";
        })

        _$candidateInfoForm.find('#changeProfileAvatar')
            .click(function () {
                changeProfileAvatar.open({ userId: 3 });
            });
