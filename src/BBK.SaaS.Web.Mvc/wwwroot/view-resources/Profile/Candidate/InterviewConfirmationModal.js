(function ($) {
    app.modals.InterviewConfirmationModal = function () {
        ...
        this.init = function (modalManager) {
            ...
            _frmMakeAnAppointmentForm = _modalManager.getModal().find('form[name=InterviewConfirmationModal]');
        }
        ...
        this.save = function () {
            ...
            $.ajax({
                ...
                abp.notify.info(abp.localization.localize("Xác nhận phỏng vấn thành công"))
