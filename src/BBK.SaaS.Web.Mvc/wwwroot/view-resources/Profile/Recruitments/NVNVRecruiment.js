(function () {
    ...
    var _Modal = new app.ModalManager({
        viewUrl: abp.appPath + 'Profile/Recruitments/EditRecruitment',
        scriptUrl: abp.appPath + 'view-resources/Profile/Recruitments/Update.js',
    ...
    var getFilter = function () {
        ...
        if ($('#RecruiterId').val() != "") {
            dataFilter.recruiterId = $('#RecruiterId').val();
        }
    ...
    var dataTable = _$RecruitmentTable.DataTable({
        ...
        pageLength: 10,
        listAction: {
            ajaxFunction: _recruitmentService.getAllByNVNV,
        ...
        columnDefs: [
            ...
            },
            {
                ...
                targets: 5,
                render: function (data, type, row, meta) {
                    return row.formOfWorks.displayName
                }
            },
            {
                orderable: true,
                                        ...
                                        if (isConfirmed) {
                                            $.ajax({
                                                ...
                                                success: function (results) {
                                                    abp.notify.info(abp.localization.localize("Xoá tin thành công"));
                                                    getDocs();
                                                },
