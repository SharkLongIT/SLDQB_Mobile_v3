    ...
    $(function () {
        ...
        var filter = function () {
            ...
            if ($('#WorkSite').val() != 0 && $('#WorkSite').val() != undefined && $('#WorkSite').val() != null) {
                datafilter.provinceId = $('#WorkSite').val();
            }
        ...
        var dataTable = _$usersTable.DataTable({
            ...
            processing: true,
            listAction: {
                ajaxFunction: _nVNVCandidateService.getAllCandidateOfProfessionalStaff,
                inputFilter: filter,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    data: 'name',
                    render: function (userName, type, row, meta) {
                        return /*row.user.surname + " " +*/ row.user.name;
                    }
                },
                {
                    targets: 2,
                ...
                },
                {
                    ...
                    data: 'emailAddress',
                    render: function (userName, type, row, meta) {
                         return row.user.phoneNumber == null ? "" : row.user.phoneNumber;
                    }
                },
                {
                    targets: 5,
                ...
                },
                {
                    ...
                    //},
                    render: function (userName, type, row, meta) {
                        return row.candidate.district.displayName + ","+  row.candidate.province.displayName  ;
                    }
                },
                //{
                //    targets: 7,
                        ...
                        items: [
                            {
                                ...
                                //},
                                  action: function (data) {
                                       window.location.href = "/Profile/UsersType1/CurriculumVitaeJobApplication?userId=" + data.record.user.id;
                                    //  window.open("/Profile/UsersType1/CurriculumVitaeJobApplication?userId=" + data.record.user.id, "_blank");
                                },
                            },
                            {
                                ...
                                action: function (data) {
                                    //window.open("/Profile/Candidate/Detail?Id=" + data.record.user.id, "_blank");
                                     window.location.href = "/Profile/Candidate/Detail?Id=" + data.record.user.id;
                                },
                            },
                            {
