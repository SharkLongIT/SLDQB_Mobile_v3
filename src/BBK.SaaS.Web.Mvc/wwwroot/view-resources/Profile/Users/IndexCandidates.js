(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Profile/UsersType/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Profile/Users/_CreateOrEditModal.js',
        ...
        var dataTable = _$usersTable.DataTable({
            ...
            processing: true,
            listAction: {
                ajaxFunction: _userService.getUsersType,
            ...
            columnDefs: [
                {
                    ...
                    rowAction: {
                        ...
                        items: [
                            ...
                            // },
                            {
                                text: 'Cập nhật thông tin Người Lao Động',
                                visible: function () {
                                    return _permissions.edit;
                                },
                                action: function (data) {
                                    // alert('for CuongNV');
                                    //_createOrEditModal.open({ id: data.record.id, userType: 1 });
                                    window.open("/Profile/Candidate/Detail/" + data.record.id, "_blank");
                                },
                            },
                            //{
                            //    text: app.localize('Danh sách hồ sơ ứng tuyển'),
                            //    action: function (data) {
                            //        window.open("/Profile/UsersType1/CurriculumVitaeJobApplication?userId=" + data.record.id, "_blank");
                            //    },
                            //},
                            {
                                ...
                                action: function (data) {
                                    _createOrEditModal.open({ id: data.record.id, userType: 2 });
                                },
                            },
                            // {
        ...
        $('#CreateNewUserButton').click(function () {
            ...
            _createOrEditModal.open({ id: null, userType: 2 });
        });
