(function () {
    $(function () {
        ...
        //// model chinh sua thong tin nha tuyen dung
            ...
            columnDefs: [
                {
                    ...
                    rowAction: {
                        ...
                        items: [
                            ...
                            // },
                            {
                                text: 'Cập nhật thông tin Nhà Tuyển Dụng',
                                visible: function () {
                                ...
                                action: function (data) {
                                    ...
                                    window.open("/Profile/Recruiters/RecruiterInfo/" + data.record.id, "_blank");
                                },
                            },
                            {
                                ...
                                action: function (data) {
                                    ...
                                    //window.open("/Profile/Recruiters/Detail/" + data.record.id, "_blank");
                                },
                            },
                            // {
        ...
        $('#CreateNewUserButton').click(function () {
            ...
            _createOrEditModal.open({ id: null, userType: 1 });
        });
