(function ($) {
  ...
  //  },
  //  'Hãy nhập đúng định dạng của số điện thoại'//app.localize('TenantName_Regex_Description')
  //  );

  app.modals.CreateOrEditUserModal = function () {
    var _userService = abp.services.app.user;
    var _userTypeAppService = abp.services.app.userType;
    ...
    this.init = function (modalManager) {
      ...
      //$('#PhoneNumber').rules("add", { pattern: "(\+84|0)(9|8|7|5|3)[0-9]{8}" });
