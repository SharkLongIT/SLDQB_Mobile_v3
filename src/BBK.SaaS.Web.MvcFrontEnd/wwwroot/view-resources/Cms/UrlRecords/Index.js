(function () {
  $(function () {
	var _urlRecordService = abp.services.app.urlRecord;
	...
	var dataTable = _$topicsTable.DataTable({
	  ...
	  processing: true,
	  listAction: {
		ajaxFunction: _urlRecordService.getUrlRecords,
	...
	function deleteTopic(topic) {
	  ...
	  abp.message.confirm(
		...
		'Bạn có chắc chắn xóa "' + topic.slug + '"',
	...
	$('#SyncViewedCount').click(function () {
	  _urlRecordService
		.syncViewedCountFromCache()
		.done(function (results) {
		  //getTopics(true);
		  console.log(results);
		  abp.message.success(app.localize('Successfully') + ': ' + results + ' items');
		});
	});
