$(function () {
        ...
        ajax: function (url, data, callBack, beforeSend, handleData) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (handleData != undefined && result != undefined) {
                        handleData
                    }
                },
    ...
    var JobApplication = {
        ...
        update: function () {
            ...
            data.CandidateId = $('input[name=CandidateId]').val();
            data.fileMgr = {};
            data.fileMgr.fileName = "FileJobApplication";
        ...
        reload: function (data) {
            ...
            if (data.result.length > 0) {
                ...
                $.each(data.result, function (index, value) {
                    ...
                    var divPositions = $('<div>').addClass('col-md-12 col-lg-12 d-flex mt-3 mb-1').attr({
                        ...
                        .append($('<div>')
                            .append(aTextDelete)
                            .append(aTextUpdate));
                    var divCompanyName = $('<div>').addClass('col-md-12 col-lg-12 fw-bolder mb-1')
                        .append($('<p>').attr({
                            "class": "text-muted",
                            "id": "CompanyName",
                            "name": "CompanyName",
                        }).append($('<strong>').text(value.companyName)));
                ...
                $.each(data.result, function (index, value) {
                    ...
                    var divPositions = $('<div>').addClass('col-md-12 col-lg-12 d-flex mt-3 mb-1').attr({
                        ...
                        .append($('<div>')
                            .append(aTextDelete)
                            .append(aTextUpdate));
                    var divschoolName = $('<div>').addClass('col-md-12 col-lg-12 mb-1')
                        .append($('<p>').attr({
                            "class": "text-muted",
                            "id": "SchoolName",
                            "name": "SchoolName",
                        }).append($('<strong>').text(value.schoolName)));
                    var divStartTime = $('<div>').addClass('col-md-12 col-lg-12')
                        .append($('<small>').attr({
                            "id": "StartTime",
                            "name": "StartTime",
