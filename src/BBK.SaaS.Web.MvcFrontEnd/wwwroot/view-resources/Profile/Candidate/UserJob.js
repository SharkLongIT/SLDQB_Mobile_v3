$(function () {
    ...
    var filter = {
        ...
        changeInput: function () {
            var url = abp.appPath + "Profile/JobApplication/GetUserJob";
                ...
                $.each(respone.result.candidate, function (index, value) {
                    var divAvatar = $('<div>')
                        ...
                        .append($('<div>')
                            ...
                            .append($('<img>')
                                .addClass('img-custom-thumbnail img-rounded user-edit-dialog-profile-image m-r-10 img-130')
                                .attr({
                                    'src': '/Profile/GetProfilePictureByUser?userId=' + value.user.id + '&&profilePictureId=',
                                    'width': 195,
                                    'height': 195
                                })));
                    ...
                    var divbutton = $('<div>').addClass('d-flex justify-content-end')
                        ...
                        .append($('<button>').click(function () {
                            window.location.href = abp.appPath + "Profile/JobApplication/Detail?id=" + value.jobApplication.id;
                        }).text('Xem hồ sơ')
                    ...
                    var divInfor = $('<div>')
                        ...
                        .append($('<div>')
                            ...
                            .append($('<h5>').addClass('text-black mb-3')
                                .append($('<a>')
                                    .attr({
                                        'href': abp.appPath + "Profile/JobApplication/Detail?id=" + value.jobApplication.id
                                    })
