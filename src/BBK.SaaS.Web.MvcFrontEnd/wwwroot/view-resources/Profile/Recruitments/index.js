(function () {
    ...
    var dataTable = _$RecruitmentTable.DataTable({
        ...
        //},
        "ajax": {
            "url": "/Profile/Recruitments/getAll",
            data: function (d) {
                d.filtered = $('#SearchTerm').val();
                if ($('#FormOfWork').val() != "") {
                    d.formOfWork = $('#FormOfWork').val();
                }
                if ($('#Experience').val() != "") {
                ...
                d.numberOfRecruits = $('#NumberOfRecruits').val();
                d.fromDate = $("#StartDay").val();
                d.toDate = $("#EndDay").val();
            },
