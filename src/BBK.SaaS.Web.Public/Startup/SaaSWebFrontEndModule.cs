...
namespace BBK.SaaS.Web.Public.Startup
{
    [DependsOn(
        typeof(SaaSWebCoreModule)
    )]
    public class SaaSWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SaaSWebFrontEndModule(IWebHostEnvironment env, SaaSEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SaaSWebFrontEndModule).GetAssembly());
        }
    }
}
