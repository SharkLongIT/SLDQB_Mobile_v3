...
using BBK.SaaS.Url;
using BBK.SaaS.Web.Public.Startup;
using BBK.SaaS.Web.Session;
using BBK.SaaS.Web.UiCustomization;

namespace BBK.SaaS.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SaaSViewComponent
    {
