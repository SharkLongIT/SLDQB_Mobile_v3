...
namespace BBK.SaaS.Authorization.Users.Profile
{
    public class ProxyProfileAppService : ProxyAppServiceBase, IProfileAppService
    {
        ...
        {
            return await ApiClient.GetAnonymousAsync<GetProfilePictureOutput>(GetEndpoint(nameof(GetProfilePictureByUser)),
                new {userId = userId});
        }
