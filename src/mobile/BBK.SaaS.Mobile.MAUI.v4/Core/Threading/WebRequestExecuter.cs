...
namespace BBK.SaaS.Core.Threading
{
    public static class WebRequestExecuter
    {
            ...
            Action finallyCallback = null)
        {
            ...
            try
            {
                if (!CrossConnectivity.Current.IsConnected)
                {
                    ...
                    var accepted = await UserDialogsService.Instance.Confirm(L.Localize("Bạn có muốn bật Internet và thử lại không"), L.Localize("Không có kết nối mạng"));
                    ...
                    {
                        await failCallback(new System.Exception(L.Localize("Không có kết nối mạng")));
                    }
                }
                else
                {
            ...
            Action finallyCallback = null)
        {
            ...
            try
            {
                if (!CrossConnectivity.Current.IsConnected)
                {
                    ...
                    var accepted = await UserDialogsService.Instance.Confirm(L.Localize("Bạn có muốn thử lại"), L.Localize("Không có kết nối mạng"));
            ...
            Func<System.Exception, Task> failCallback)
        {
            ...
            var accepted = await UserDialogsService.Instance.Confirm(L.Localize("Bạn có muốn thử lại"), L.Localize("Hết thời gian yêu cầu"));
            ...
            Func<System.Exception, Task> failCallback)
        {
            ...
            var accepted = await UserDialogsService.Instance.Confirm(httpExceptionMessage +" "+ L.Localize("Bạn có muốn thử lại"), L.Localize("Ngoại lệ HTTP"));
            ...
            Func<System.Exception, Task> failCallback)
        {
            ...
            var accepted = await UserDialogsService.Instance.Confirm(L.Localize("Bạn có muốn thử lại"), L.Localize("Lỗi kết nối"));
