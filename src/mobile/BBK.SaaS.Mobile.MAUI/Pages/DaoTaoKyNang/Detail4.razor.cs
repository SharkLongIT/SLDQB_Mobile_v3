...
{
    public partial class Detail4 : SaaSMainLayoutPageComponentBase
    {
        [Inject]
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            var querySegment = NavigationManager.Uri.Substring(NavigationManager.Uri.IndexOf("Detail4") + "Detail4".Length);
        ...
        {
            navigationService.NavigateTo($"Detail4?Id={article.Id}");
            await OnInitializedAsync();
