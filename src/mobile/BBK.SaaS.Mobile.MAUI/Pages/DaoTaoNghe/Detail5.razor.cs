...
{
    public partial class Detail5 : SaaSMainLayoutPageComponentBase
    {
        [Inject]
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            var querySegment = NavigationManager.Uri.Substring(NavigationManager.Uri.IndexOf("Detail5") + "Detail5".Length);
        ...
        {
            navigationService.NavigateTo($"Detail5?Id={article.Id}");
