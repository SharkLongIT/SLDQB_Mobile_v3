...
namespace BBK.SaaS.Mobile.MAUI.Pages.DichVuKhac
{
    public partial class Detail6 : SaaSMainLayoutPageComponentBase
    {
        [Inject]
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            var querySegment = NavigationManager.Uri.Substring(NavigationManager.Uri.IndexOf("Detail6") + "Detail6".Length);
        ...
        {
            navigationService.NavigateTo($"Detail6?Id={article.Id}");
