...
namespace BBK.SaaS.Mobile.MAUI.Pages.DichVuKhac
{
    public partial class Index : SaaSMainLayoutPageComponentBase
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            await SetPageHeader(L("Dịch vụ khác"), new List<Services.UI.PageHeaderButton>()
            {
        ...
        public async Task ViewArticle(ArticleModel article)
        {
            ...
            // navigationService.NavigateTo($"Detail6?Id={article.Id}&PrimaryImageUrl={article.PrimaryImageUrl}");
        }
