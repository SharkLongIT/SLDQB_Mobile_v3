...
namespace BBK.SaaS.Mobile.MAUI.Pages.ThongTinDuHoc
{
    public partial class Index : SaaSMainLayoutPageComponentBase
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            await SetPageHeader(L("Thông tin du học"), new List<Services.UI.PageHeaderButton>()
            {
        ...
        public async Task ViewArticle(ArticleModel article)
        {
            ...
            // navigationService.NavigateTo($"Detail2?Id={article.Id}&PrimaryImageUrl={article.PrimaryImageUrl}");
        }
