...
namespace BBK.SaaS.Mobile.MAUI.Pages.ThongTinXuatKhauLaoDong
{
    public partial class Detail3 : SaaSMainLayoutPageComponentBase
    {
        [Inject]
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            var querySegment = NavigationManager.Uri.Substring(NavigationManager.Uri.IndexOf("Detail3") + "Detail3".Length);
        ...
        {
            navigationService.NavigateTo($"Detail3?Id={article.Id}");
            await OnInitializedAsync();
