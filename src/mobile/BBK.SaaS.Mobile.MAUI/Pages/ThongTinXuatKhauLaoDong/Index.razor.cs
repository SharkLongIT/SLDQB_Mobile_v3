...
namespace BBK.SaaS.Mobile.MAUI.Pages.ThongTinXuatKhauLaoDong
{
    public partial class Index : SaaSMainLayoutPageComponentBase
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            await SetPageHeader(L("Thông tin xuất khẩu lao động"), new List<Services.UI.PageHeaderButton>()
            {
        ...
        public async Task ViewArticle(ArticleModel article)
        {
            ...
            //navigationService.NavigateTo($"Detail3?Id={article.Id}&PrimaryImageUrl={article.PrimaryImageUrl}");
        }
