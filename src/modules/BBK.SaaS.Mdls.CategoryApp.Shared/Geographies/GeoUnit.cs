...
{
	[Table("GeoUnits", Schema = "BBK")]
	public class GeoUnit: CreationAuditedEntity<long>, IMayHaveTenant
	{
		/// <summary>
		...
		/// <summary>
		/// Parent <see cref="GeoUnit"/>.
		/// Null, if this OU is root.
		/// </summary>
		[ForeignKey("ParentId")]
        public virtual GeoUnit Parent { get; set; }

        /// <summary>
        /// Parent <see cref="GeoUnit"/> Id.
        /// Null, if this OU is root.
        /// </summary>
        ...
        /// Children of this OU.
        /// </summary>
        public virtual ICollection<GeoUnit> Children { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="GeoUnit"/> class.
        /// </summary>
        public GeoUnit()
        {
        ...
        public GeoUnit(int? tenantId, string displayName, long? parentId = null)
        {
            TenantId = tenantId;
