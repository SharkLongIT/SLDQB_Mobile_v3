...
{
	//[Table("CatIndexings", Schema = "BBK")]
	//public class CatIndexing : CreationAuditedEntity<long>, IMayHaveTenant
	//{
	...
	[Table("CatUnits", Schema = "BBK")]
	public class CatUnit : CreationAuditedEntity<long>, IMayHaveTenant
	{
		/// <summary>
		...
		/// </summary>
		[ForeignKey("ParentId")]
		public virtual CatUnit Parent { get; set; }
		...
		/// <summary>
		/// Hierarchical Code of this category unit.
		/// Example: "HinhThucGiaoDich", "QuyMoCongTy".
		/// This is a unique code for a Tenant.
		/// It's changeable if OU hierarch is changed.
		/// </summary>
		[StringLength(SaaSConsts.MaxCodeLineLength)]
    ...
    public virtual int OrderIndex { get; set; }
		...
		/// Children of this OU.
		/// </summary>
		public virtual ICollection<CatUnit> Children { get; set; }
		...
		public CatUnit(int? tenantId, string displayName, long? parentId = null)
		{
			TenantId = tenantId;
