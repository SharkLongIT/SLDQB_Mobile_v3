...
{
	[Table("AppMediaFolders", Schema = SaaSCmsConsts.DefaultSchema)]
	public class MediaFolder : CreationAuditedEntity<long>, IMayHaveTenant
	{
		/// <summary>
		...
		/// <summary>
		/// Parent <see cref="MediaFolder"/> Id.
		/// Null, if this OU is root.
		/// </summary>
		...
		public MediaFolder(int? tenantId, string displayName, long? parentId = null)
		{
			TenantId = tenantId;
