...
using BBK.SaaS.MultiTenancy.HostDashboard;
using BBK.SaaS.MultiTenancy.HostDashboard.Dto;
using BBK.SaaS.MultiTenancy.Payments;
using Shouldly;
using System.Globalization;
using BBK.SaaS.EntityFrameworkCore;

namespace BBK.SaaS.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SaaSDbContext context, SubscriptionPayment subscriptionPayment)
        {
