...
using BBK.SaaS.Localization.Dto;
using BBK.SaaS.Migrations.Seed.Host;
using BBK.SaaS.Test.Base;
using NSubstitute;
using Shouldly;
using Xunit;

namespace BBK.SaaS.Tests.Localization
{
    ...
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = SaaSConsts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
            ...
            var newValue = Resolve<ILocalizationManager>()
                .GetString(
                    SaaSConsts.LocalizationSourceName,
                    "Save",
